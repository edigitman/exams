package ro.ghasachi.bt.web.error;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNotFound(final RuntimeException ex, final WebRequest request) {
        final String bodyOfResponse = "EntityNotFoundException or MyResourceNotFoundException";
    ...
    protected ResponseEntity<Object> handleConflict(final RuntimeException ex, final WebRequest request) {
        final String bodyOfResponse = "InvalidDataAccessApiUsageException or DataAccessException";
    ...
    /*500*/public ResponseEntity<Object> handleInternal(final RuntimeException ex, final WebRequest request) {
        ...
        final String bodyOfResponse = "NullPointerException or IllegalArgumentException or IllegalStateException";
