...
public class RootController {
	...
	public void adminRoot(final HttpServletRequest request, final HttpServletResponse response) {
		...
		final String linkToProfExamInst = LinkUtil.createLinkHeader(profExamInstUri.toASCIIString(),
				"prof exam instance crud");

		final URI profExamItemUri = new UriTemplate("{rootUri}/{resource}").expand(rootUri, "prof/examItem");
		final String linkToProfExamItem = LinkUtil.createLinkHeader(profExamItemUri.toASCIIString(),
				"prof exam item crud");

		final URI profExamGroupUri = new UriTemplate("{rootUri}/{resource}").expand(rootUri, "prof/examGroup");
		final String linkToProfExamGroup = LinkUtil.createLinkHeader(profExamGroupUri.toASCIIString(),
				"prof exam group crud");

		final URI profExamItemAnswUri = new UriTemplate("{rootUri}/{resource}").expand(rootUri, "prof/examItemAnswer");
		final String linkToProfExamItemAnsw = LinkUtil.createLinkHeader(profExamItemAnswUri.toASCIIString(),
				"prof exam item answer crud");
